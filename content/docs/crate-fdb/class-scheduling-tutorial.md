...
[`fdb::open_database`](https://docs.rs/fdb/0.3.1/fdb/fn.open_database.html)
...
[`run()`](https://docs.rs/fdb/0.3.1/fdb/database/struct.FdbDatabase.html#method.run)
method. We will also use methods on type
[`Tuple`](https://docs.rs/fdb/0.3.1/fdb/tuple/struct.Tuple.html) to
[`pack()`](https://docs.rs/fdb/0.3.1/fdb/tuple/struct.Tuple.html#method.pack)
...
[`Transaction`](https://docs.rs/fdb/0.3.1/fdb/transaction/trait.Transaction.html)
and
...
[`error`](https://docs.rs/fdb/0.3.1/fdb/error/index.html) module and
[`FdbError`](https://docs.rs/fdb/0.3.1/fdb/error/struct.FdbError.html)
...
[`TransactionOption::RetryLimit`](https://docs.rs/fdb/0.3.1/fdb/transaction/enum.TransactionOption.html#variant.RetryLimit)
and
[`Transaction::Timeout`](https://docs.rs/fdb/0.3.1/fdb/transaction/enum.TransactionOption.html#variant.Timeout)
to
[`ReadTransaction::set_option`](https://docs.rs/fdb/0.3.1/fdb/transaction/trait.ReadTransaction.html#tymethod.set_option)
method or at the database level by passing
[`DatabaseOption::TransactionRetryLimit`](https://docs.rs/fdb/0.3.1/fdb/database/enum.DatabaseOption.html#variant.TransactionRetryLimit)
and
[`DatabaseOption::TransactionRetryLimit`](https://docs.rs/fdb/0.3.1/fdb/database/enum.DatabaseOption.html#variant.TransactionRetryLimit)
to
[`FdbDatabase::set_option`](https://docs.rs/fdb/0.3.1/fdb/database/struct.FdbDatabase.html#method.set_option)
...
[`get_range()`](https://docs.rs/fdb/0.3.1/fdb/transaction/trait.ReadTransaction.html#tymethod.get_range)
method, which is called from
[`into_stream()`](https://docs.rs/fdb/0.3.1/fdb/range/struct.Range.html#method.into_stream)
method.
...
In general, the
[`Tuple::range()`](https://docs.rs/fdb/0.3.1/fdb/tuple/struct.Tuple.html#method.range)
method returns a
...
[`Range::into_stream()`](https://docs.rs/fdb/0.3.1/fdb/range/struct.Range.html#method.into_stream)
to obtain a Tokio
...
[`Tuple::fromBytes()`](https://docs.rs/fdb/0.3.1/fdb/tuple/struct.Tuple.html#method.from_bytes)
...
[`clear()`](https://docs.rs/fdb/0.3.1/fdb/transaction/trait.Transaction.html#tymethod.clear)
method.
